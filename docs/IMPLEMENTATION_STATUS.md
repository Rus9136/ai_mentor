...
| Следующая итерация | Итерация 3 (Backend + JWT + SUPER_ADMIN роль) |
| Всего миграций БД | 8 (001-008), планируется 009 (SUPER_ADMIN) |
